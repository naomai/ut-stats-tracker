...
#End Region
    ...
    Public Function sreadNext() As String
        sreadNext = ASCII.GetString(sreadNextBytes())
    End Function
            ...
            SyncLock threadLocker
                ...
                If socketx.Available > 0 Then
                    ...
                    Try
                        ...
                        'Debugger.Break()
                        ' End If
                        bytesread = socketx.ReceiveFrom(buffer, remotex)
                        'socketx.Receive(buffer, socketx.Available, SocketFlags.None)
                        If bytesread > 0 Then
                            ...
                            btmp = Left(ASCII.GetString(buffercopy), bytesread)
    ...
    Public Function recvfrom(ByRef source As IPEndPoint)
    ...
    Public Sub UdpSwriteTo(ByVal destip As String, ByVal destport As Integer, ByVal packet As String) '
        ...
        End If
        socketudp.Send(ASCII.GetBytes(packet), Len(packet), remoteX)
        'Thread.Sleep(10)
    End Sub
    Public Function UdpSreadNext() As String
        ...
        Try
            ...
            UdpSreadNext = ASCII.GetString(buffer)
        Catch exc
            UdpSreadNext = ""
        End Try
